...
export function OurTeamSection({ id }: { id: string }) {
  const team = {
    'Web Developers': [
      { name: 'Deepak Bagada', role: 'Lead Web Developer', image: 'https://topcluessolutions.in/wp-content/uploads/2025/02/Deepak-bagada-web-designer.webp', hint: 'developer portrait' },
